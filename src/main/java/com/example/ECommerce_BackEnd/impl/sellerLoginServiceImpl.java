...
//        Optional<sellerLogin> opUser = Optional.ofNullable(sellerLoginRepository.findSellerInfo(sellerUsername));
...
//        }
    ...
    //2. Register Seller
    @Override
    public ResponseEntity<sellerLogin> saveSellerLogin(sellerData2 sellerData2) throws Exception {
        ...
        return new ResponseEntity<sellerLogin>(sellerLoginRepository.save(sellerLoginLoginData), HttpStatus.CREATED);
    }
